...
g.parse( "source/Datasets/EnDe-Lite50(without_Ontology).ttl")
...
print("***** START VALIDATION ON [EnDe-Lite50] *****")
...
v_g1.serialize(destination="Outputs/EnDe-Lite50/violationGraph/pyshacl_results.ttl")

# Saving the validation report in txt

file = open("Outputs/EnDe-Lite50/validationReports/pyshacl_results.txt", "w")
file.write(v_t1)
file.close()
...
v_g2.serialize(destination="Outputs/EnDe-Lite50/violationGraph/re-shacl_results.ttl")

# Saving the validation report in txt

file = open("Outputs/EnDe-Lite50/validationReports/re-shacl_results.txt", "w")
file.write(v_t2)
file.close()
...
# v_g3.serialize(destination="Outputs/EnDe-Lite50/violationGraph/pyshacl-owl_results.ttl")

# # Saving the validation report in txt

# file = open("Outputs/EnDe-Lite50/validationReports/pyshacl-owl_results.txt", "w")
# file.write(v_t3)
# file.close()
