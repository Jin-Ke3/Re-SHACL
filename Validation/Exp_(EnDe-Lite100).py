...
v_g3.serialize(destination="Outputs/EnDe-Lite100/violationGraph/pyshacl-owl_results.ttl")

# Saving the validation report in txt

file = open("Outputs/EnDe-Lite100/validationReports/pyshacl-owl_results.txt", "w")
file.write(v_t3)
file.close()
