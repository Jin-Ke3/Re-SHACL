...
g.parse( "source/Datasets/EnDe-Lite1000(without_Ontology).ttl")
...
print("***** START VALIDATION ON [EnDe-Lite1000] *****")
...
v_g1.serialize(destination="Outputs/EnDe-Lite1000/violationGraph/pyshacl_results.ttl")

# Saving the validation report in txt

file = open("Outputs/EnDe-Lite1000/validationReports/pyshacl_results.txt", "w")
file.write(v_t1)
file.close()
...
v_g2.serialize(destination="Outputs/EnDe-Lite1000/violationGraph/re-shacl_results.ttl")

# Saving the validation report in txt

file = open("Outputs/EnDe-Lite1000/validationReports/re-shacl_results.txt", "w")
file.write(v_t2)
file.close()
