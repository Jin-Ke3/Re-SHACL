...
g.parse( "source/Datasets/EnDe-10(without_Ontology).ttl")
...
print("***** START VALIDATION ON [EnDe-10] *****")
...
v_g1.serialize(destination="Outputs/EnDe-10/violationGraph/pyshacl_results.ttl")

# Saving the validation report in txt

file = open("Outputs/EnDe-10/validationReports/pyshacl_results.txt", "w")
file.write(v_t1)
file.close()
...
v_g2.serialize(destination="Outputs/EnDe-10/violationGraph/re-shacl_results.ttl")

# Saving the validation report in txt

file = open("Outputs/EnDe-10/validationReports/re-shacl_results.txt", "w")
file.write(v_t2)
file.close()
...
# v_g3.serialize(destination="Outputs/EnDe-10/violationGraph/pyshacl-owl_results.ttl")

# # Saving the validation report in txt

# file = open("Outputs/EnDe-10/validationReports/pyshacl-owl_results.txt", "w")
# file.write(v_t3)
# file.close()
...
file_table = open("Outputs/EnDe-10/RunTimeResults.txt", "a+")
